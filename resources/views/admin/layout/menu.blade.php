   <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin/user/list"><i class="fa fa-bar-chart-o fa-fw"></i> Users<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="admin/location/list"><i class="fa fa-bar-chart-o fa-fw"></i> Quán ăn<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/location/list">List</a>
                                </li>
                                <li>
                                    <a href="admin/location/add">Add</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
